...
user.textrans = {
    ...
    "Bad value for %%microscale": "fehlerhafter Wert für %%microscale",
    "Bad value for %%notespacingfactor": "fehlerhafter Wert für %%notespacingfactor",
	"Bad value for %%ottava": "fehlerhafter Wert für %%ottava",
    "Bad value for %%voicecombine": "fehlerhafter Wert für %%voicecombine",
    "Bad value for %%voicescale": "fehlerhafter Wert für %%voicescale",
    ...
    "Misplaced '[' in %%staves": "'[' fehlerhaft platziert in %%staves",
    "Misplaced '{' in %%staves": "'{' fehlerhaft platziert in %%staves",
    "Misplaced '(' in %%staves": "'(' fehlerhaft platziert in %%staves",
    "Misplaced ']' in %%staves": "']' fehlerhaft platziert in %%staves",
    "Misplaced '}' in %%staves": "'}' fehlerhaft platziert in %%staves",
    ...
    "No note before '<'": "keine Note vor '<'",
    "No note before start of voice overlay": "keine Note vor Stimmüberlagerung",
